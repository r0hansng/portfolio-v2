        ...
        <>
            <section className="relative flex items-center justify-center rounded-md bg-background/[0.96] py-16 md:py-48">
                ...
                >
                    ...
                    <div className="text-3xl sm:text-5xl md:text-7xl font-bold">Rohan Singh</div>
                    <div className="text-3xl sm:text-5xl md:text-7xl font-bold">Front-End Developer</div>
