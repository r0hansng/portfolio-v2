        ...
        <motion.div ref={ref} className={cn("relative w-full max-w-4xl mx-auto h-full", className)}>
            <div className="absolute -left-4 md:-left-20 top-3">
                <motion.div
                    ...
                    className="ml-[27px] h-4 w-4 rounded-full border border-gray-800 shadow-sm flex items-center justify-center"
                >
                    <motion.div
                        transition={{ duration: 0.2, delay: 0.5 }}
                        animate={{
                ...
                <svg viewBox={`0 0 20 ${svgHeight}`} width="20" height={svgHeight} className="block ml-4" aria-hidden="true">
                    <motion.path
